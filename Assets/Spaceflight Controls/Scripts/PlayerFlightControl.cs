...
public class PlayerFlightControl : MonoBehaviour
{
	...
	void Start() 
    {
		...
		try
        {
            Input.GetAxis("Controller " + 1 + " - Trigger");
		...
		try 
        {
            Input.GetAxis("Controller " + 1 + " - Horizontal");
    ...
    { 
        ...
        if (roll_exists)
			roll = (Input.GetAxis("Controller " + 1 + " - Horizontal") * -rollSpeedModifier);


        pitch = (Input.GetAxis("Controller " + 1 + " - Vertical") * pitchYaw_strength);
		...
		if(thrust_exists) 
        {
			if (Input.GetAxis("Controller " + 1 + " - Trigger") > 0) 
            {
            ...
            else if (Input.GetAxis("Controller " + 1 + " - Trigger") < 0)
